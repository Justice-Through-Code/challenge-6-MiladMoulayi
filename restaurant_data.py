...
def explore_data():
    ...
    latitude = restaurant_1['latitude']
    longitude = restaurant_1['longitude']
    ...
    city = restaurant_1['city']
    state = restaurant_1['state']
    zip_code = restaurant_1['zip_code']
...
def favorite_restaurant():
    ...
    favorite_dish = input('What is your favorite dish at this restaurant? ')
